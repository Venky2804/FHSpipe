...
parser.add_argument("--len", help="Length filter cut off (in number of nucleotides) [Default: 200]", type=int, action="store", default="200")
parser.add_argument("--orfl", help="ORF Length filter cut off (in number of amino acids) [Default: 100]", type=int, action="store", default="100")
parser.add_argument("-o", "--out", help="Prefix of output files [Default: out]", action="store", default="out")
parser.add_argument("-t", "--threads", type=int, help="Number of threads [Default: 1]", action="store", default="1")
